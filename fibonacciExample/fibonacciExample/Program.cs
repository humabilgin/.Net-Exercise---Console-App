    ...
    internal class Program
    {
        ...
        static List<int> ReadInputAndFindNumbers()
        {
            ...
            while (true)
            {
                ...
                {
                    //int intNumber = int.TryParse(singleInput);
                    int intNumber;
                    bool success = int.TryParse(singleInput, out intNumber);
                    if (success)
                    {
                        sum = sum + intNumber;
                    ...
                    {
                        Console.WriteLine($"The number '{singleInput ?? "<null>"}' is too big to process.");
                    }
